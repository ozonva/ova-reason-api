...
// Source: github.com/ozonva/ova-reason-api/internal/repo (interfaces: Repo)
...
import (
	...
	model "github.com/ozonva/ova-reason-api/internal/model"
)
...
func (m *MockRepo) AddEntities(arg0 []model.Reason) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(arg0 uint64) (*model.Reason, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DescribeEntity", arg0)
	ret0, _ := ret[0].(*model.Reason)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepo) ListEntities(arg0, arg1 uint64) ([]model.Reason, error) {
	m.ctrl.T.Helper()
